---
title: "Remove Book from User"
api: "DELETE /api/v1/users/{userId}/books/{bookId}"
description: "Removes a book from a user's collection"
---
...
| Code | Description |
|------|-------------|
| 200  | Successfully removed book from user's collection |
